...
{
    public class ActualizaDatosCliLN : InterfazGestor
    {
        public override DataTable DataTableGenerico(DataSet DsResultado)
        {
            ...
            DTConsultaGenerico.TableName = "ActualizaDatosCli";
            ...
            for (int i = 0; i < DsResultado.Tables["Resultado"].Rows.Count; i++)
            {
                ...
                , FormateoCampos.FormatoHTML(DsResultado.Tables["Resultado"].Rows[i]["CIUDADT1"].ToString().Trim())
                ...
                , FormateoCampos.FormatoHTML(DsResultado.Tables["Resultado"].Rows[i]["CIUDADT2"].ToString().Trim())
